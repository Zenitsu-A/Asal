...
const ANIMATION_VIDEOS = [
  "https://youtube.com/shorts/zGUdr9lypfc",
  "https://youtube.com/shorts/_XCwHuGLYI4?feature=share",
  "https://youtube.com/shorts/ohwElc7e9io?feature=share",
  "https://youtube.com/shorts/JbEvWMBrAQw?feature=share",
  "https://youtube.com/shorts/lpgvLMXn9gA?feature=share",
  "https://youtube.com/shorts/8fMERgG9ZI4?feature=share",
  "https://youtube.com/shorts/LPpphqOwHQo?feature=share",
  "https://youtu.be/gAkfJdaUnp8",
  "https://youtu.be/RTSE2dwaSl0",
  "https://youtu.be/TKHVR0RFkPg?si=NS_Z-GTWwIyLE79C",
  "https://www.tiktok.com/@omarnasrmusic/video/7393007755377904913?is_from_webapp=1&sender_device=pc&web_id=7636947654736217616"
];

// Upgraded to handle Shorts, standard YouTube links, and TikToks
...
// Helper to determine platform label dynamically
...
export const Animations2DProject = () => {
      ...
      >
        ...
        <div className="mb-12 text-center relative z-10">
          ...
          <div className="relative mx-auto mt-4 max-w-lg">
            ...
            >
              Creative 2D animation and motion design that brings stories to life. Delivering vibrant visuals and generating <span className="text-amber-400 font-semibold">1 million views</span> for elite clients including MABI Studio, OMAR NASR, and OCEAN HOME.
            </motion.p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          {/* Left Column - Video Gallery (7 cols) */}
          <motion.div
                  ...
                  <div className="flex gap-4 px-1 pb-4">
                    {ANIMATION_VIDEOS.map((url, i) => (
                      ...
                      >
                        ...
                        {/* Force 9:16 aspect ratio perfectly */}
              ...
              >
                ...
                <div className="relative">
                  ...
                  <blockquote className="relative z-10 pl-5">
                    <p className="text-base leading-relaxed font-medium italic text-zinc-100 lg:text-lg">
                      &ldquo;Ahmed's 2D animations are simply on another level. He effortlessly translated our brand's complex concepts into engaging, fluid motion graphics. The final assets were vibrant, eye-catching, and <span className="text-amber-400">exactly what we needed</span> to captivate our audience!&rdquo;
                    </p>
                ...
                <div className="mt-6 flex items-center justify-between border-t border-zinc-800/60 pt-6">
                  <div className="text-center flex-1 border-r border-zinc-800/60">
                    <p className="text-xl font-bold text-amber-400/80">{ANIMATION_VIDEOS.length}</p>
                    <p className="text-[10px] text-zinc-500 uppercase tracking-wider mt-1">Videos</p>
                  </div>
                  
                  {/* Heavily Emphasized & Animated 1M+ Views Stat */}
                ...
                >
                  ...
                  <div className="pt-8">
                    ...
                    <div className="space-y-4">
                      {[
                        {
                          text: "Character animation with fluid motion and expressive timing.",
                        },
                        {
                          text: "Background design and layout with vibrant color palettes.",
                        },
                        {
                          text: "Sound design and synced audio-visual storytelling.",
                        },
                      ].map((item, i) => (
                        <motion.div
                          key={i}
