...
const MAP_VIDEOS = [
  "https://www.tiktok.com/@ahmedsalahmedia/video/7272015619413789958?is_from_webapp=1&sender_device=pc&web_id=7636947654736217616",
  "https://www.tiktok.com/@ahmedsalahmedia/video/7277641467550584069?is_from_webapp=1&sender_device=pc&web_id=7636947654736217616",
  "https://www.tiktok.com/@ahmedsalahmedia/video/7267961833498119429?is_from_webapp=1&sender_device=pc&web_id=7636947654736217616",
  "https://www.tiktok.com/@ahmedsalahmedia/video/7274548889255005445?is_from_webapp=1&sender_device=pc&web_id=7636947654736217616",
  "https://www.tiktok.com/@ahmedsalahmedia/video/7283871134066461958?is_from_webapp=1&sender_device=pc&web_id=7636947654736217616",
  "https://www.tiktok.com/@ahmedsalahmedia/video/7290586148555017477?is_from_webapp=1&sender_device=pc&web_id=7636947654736217616",
  "https://www.tiktok.com/@ahmedsalahmedia/video/7282397062639947014?is_from_webapp=1&sender_device=pc&web_id=7636947654736217616",
  "https://www.youtube.com/shorts/0LTFIB1JPSE",
  "https://www.youtube.com/shorts/D_FMFosCQx8?feature=share",
  "https://www.youtube.com/shorts/PTJd_p8ZDvU?feature=share",
];
...
function getVideoType(url: string): "tiktok" | "youtube" {
  return url.includes("tiktok") ? "tiktok" : "youtube";
}

export const MapAnimationProject = () => {
  ...
  // Animate from 0 to 2,000,000
  useEffect(() => {
    if (isInView) {
      const controls = animate(count, 2000000, {
        duration: 3, // 3 seconds of rapid counting
        ease: [0.22, 1, 0.36, 1], // Fast start, heavy deceleration
        onComplete: () => setIsFinished(true), // Trigger the supernova effect when it finishes
      });
      return controls.stop;
    }
  }, [isInView, count]);

  // Format the number dynamically: Show full commas while counting, then strip to just "2" when finished
      ...
      >
        ...
        <div className="mb-12 text-center relative z-10">
          ...
          <div className="relative mx-auto mt-4 max-w-lg">
            ...
            >
              Dynamic map animations and motion graphics that generated <span className="text-amber-400 font-semibold">+2M views</span> for travel and location-based storytelling.
            </motion.p>
          </div>
        </div>

        {/* Two Column Layout — Videos left (7), Text right (5) */}
                      ...
                      >
                        ...
                        <div className="overflow-hidden rounded-lg bg-zinc-900 ring-1 ring-zinc-800 transition-all duration-500 group-hover/video:ring-amber-500/30">
                          <div className="h-[460px] w-[260px] shrink-0 overflow-hidden bg-black">
                            {getVideoType(url) === "tiktok" ? (
                              <iframe
                                src={getVideoEmbedUrl(url)}
                                title={`Map Animation ${i + 1}`}
                        ...
                        <figcaption className="mt-2.5 flex items-center gap-2 text-[11px] text-zinc-600">
                          ...
                          {getVideoType(url) === "tiktok" ? `TikTok #${i + 1}` : `YouTube #${i + 1}`}
                        </figcaption>
                      </motion.figure>
                    ))}
                  </div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <blockquote className="relative z-10 pl-5">
                    <p className="text-base leading-relaxed font-medium italic text-zinc-100 lg:text-lg">
                      &ldquo;The map animations Ahmed created brought our vision to life.
                      The <span className="text-amber-400">attention to geographic detail</span> and
                      smooth transitions made every reel feel like a{' '}
                      <span className="text-amber-400">cinematic journey</span>.&rdquo;
                    </p>
                ...
                <div className="mt-6 flex items-center justify-between border-t border-zinc-800/60 pt-6">
                  <div className="text-center flex-1 border-r border-zinc-800/60">
                    <p className="text-xl font-bold text-amber-400/80">10</p>
                    <p className="text-[10px] text-zinc-500 uppercase tracking-wider mt-1">Videos</p>
                  </div>
                  
                  {/* Heavily Emphasized & Animated 2M+ Views Stat */}
                  ...
                  <div className="text-center flex-1 border-l border-zinc-800/60">
                    ...
                    <p className="text-[10px] text-zinc-500 uppercase tracking-wider mt-1">Platforms</p>
                  </div>
                </div>
              </motion.div>
                ...
                >
                  ...
                  <div className="pt-8">
                    ...
                    <div className="space-y-4">
                      {[
                        {
                          text: "Custom map animation system with dynamic route tracing and location markers.",
                        },
                        {
                          text: "Smooth motion graphics with After Effects and cinematic transitions.",
                        },
                        {
                          text: "Multi-platform exports optimized for TikTok, YouTube Shorts, and Reels.",
                        },
                      ].map((item, i) => (
                        <motion.div
                          key={i}
                    ...
                    <div className="space-y-3 pt-6">
                      <p className="text-sm text-zinc-400">
                        This project involved creating a scalable map animation template for recurring travel content.
                      </p>
                    </div>
                  </div>
                </motion.div>
